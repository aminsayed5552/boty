...
async def main():
    ...
    application.add_handler(CommandHandler("بدايه", start))
    application.add_handler(CommandHandler("مساعده", help_command))
    application.add_handler(CommandHandler("حول", about_command))
    application.add_handler(CommandHandler("نكته", joke_command))
    application.add_handler(CommandHandler("تحفيز", quote_command))
    application.add_handler(CommandHandler("نصيحه", tip_command))
    application.add_handler(CommandHandler("تفاعلي", stats_command))
